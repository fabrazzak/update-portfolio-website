...
import { FaCode, FaDatabase, FaWordpress } from 'react-icons/fa'

const cards = [
  {
    icon: <FaCode />,
    title: 'Modern Web Development',
    subtitle: 'Next.js, TypeScript, React',
    details: 'Building high-performance, SEO-optimized applications',
  },
  {
    icon: <FaDatabase />,
    title: 'Backend & API Design',
    subtitle: 'MongoDB, REST, Authentication',
    details: 'Robust architecture & secure data flow',
  },
   {
    icon: <FaWordpress />,
    title: 'WordPress Customization',
    subtitle: 'Theme & Plugin Integration',
    details: 'Optimized for speed and scalability',
  },
]
...
export default function About() {
  return (
    ...
    >
      ...
      <motion.div className="max-w-4xl mt-16 text-center" variants={itemVariants}>
        <h3 className="text-xl font-bold text-cyan-400 mb-4">👨‍💻 My Approach</h3>
        <p className="text-gray-300 mb-6">
          I value clean code, efficient design patterns, and seamless user experiences. From backend logic to front-end polish, I ensure every line of code aligns with real business goals.
        </p>
        <h3 className="text-xl font-bold text-cyan-400 mb-4">🤝 Collaboration Matters</h3>
        <p className="text-gray-300">
          I believe in clear communication, agile development, and long-term partnerships. Whether you're a startup or a growing business, I’m here to help you build, scale, and succeed on the web.
        </p>
      </motion.div>
