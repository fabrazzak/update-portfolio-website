...
const achievements = [
  {
    title: "SIH'24 Finalist - Smart India Hackathon 2024",
    description: "Finalist for the NALCO problem statement at SIH 2024. Built a machine learning solution to predict aluminum wire rod parameters.",
