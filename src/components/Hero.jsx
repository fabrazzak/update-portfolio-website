...
const roles = ["Full-Stack Web Developer", "Mern  Stack Web Developer", "Wordpress Expert"];
...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Main Content Area */}
      <div className="relative flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-16 max-w-6xl w-full ">
    ...
    >
      ...
      <span className="absolute inset-0 z-10 pointer-events-none">
        <span className="absolute inset-0 animate-none group-hover:animate-border-sequence border-2 border-transparent rounded-lg" />
      </span>

      {/* Text */}
      <span className="relative z-20">View My Resume</span>
      ...
      <style jsx>{`
        ...
        .animate-border-sequence {
          animation: border-sequence 0.8s forwards;
        }
      `}</style>
    </motion.a>
        </div>
